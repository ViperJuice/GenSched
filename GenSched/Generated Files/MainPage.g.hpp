...
void ::GenSched::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::GenSched::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
    switch (__connectionId)
    {
        ...
        case 3:
            {
                this->button_ImportData = safe_cast<::Windows::UI::Xaml::Controls::Button^>(__target);
                (safe_cast<::Windows::UI::Xaml::Controls::Button^>(this->button_ImportData))->Click += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::GenSched::MainPage::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::GenSched::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
